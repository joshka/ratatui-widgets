...
impl TryFrom<CrosstermKeyCode> for Key {
    ...
    fn try_from(key_code: CrosstermKeyCode) -> Result<Self, Self::Error> {
        ...
        let key = match key_code {
            CrosstermKeyCode::Char(c) => Char(c),
            CrosstermKeyCode::Esc => Esc,
            CrosstermKeyCode::Enter => Enter,
            CrosstermKeyCode::Tab => Tab,
            CrosstermKeyCode::BackTab => BackTab,
            CrosstermKeyCode::Backspace => Backspace,
            CrosstermKeyCode::Delete => Delete,
            CrosstermKeyCode::Insert => Insert,
            CrosstermKeyCode::Left => Left,
            CrosstermKeyCode::Right => Right,
            CrosstermKeyCode::Up => Up,
            CrosstermKeyCode::Down => Down,
            CrosstermKeyCode::Home => Home,
            CrosstermKeyCode::End => End,
            CrosstermKeyCode::PageUp => PageUp,
            CrosstermKeyCode::PageDown => PageDown,
            CrosstermKeyCode::F(num) => F(num),
            CrosstermKeyCode::Null => Null,
